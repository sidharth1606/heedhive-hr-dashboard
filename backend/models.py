...
class User(db.Model):
    ...
    role          = db.Column(db.Enum('admin','hr','manager', name='user_role'), default='hr')
...
class Attendance(db.Model):
    ...
    status      = db.Column(db.Enum('present','absent','wfh','half', name='attendance_status'), nullable=False)
